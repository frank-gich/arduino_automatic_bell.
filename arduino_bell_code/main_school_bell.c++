...
//
// ce_pin  (RST): default 3
// sck_pin (CLK): default 5
// io_pin  (DAT): default 4
DS1302 rtc;
//DS1302 rtc(8, 6, 7);
//LiquidCrystal lcd(13, 12, 11, 10, 9, 8);// Pins used for RS,E,D4,D5,D6,D7 and the r/w pin is connected with the ground
...
while(now.dayOfWeek()== 1){
 
  currentTIME();
  matchTIM(); 
  
  value = EEPROM.read(monA);
  ALLDays(now.dayOfWeek());
  lcd.setCursor(0,0);
  lcd.print(mySubject[value]);
  lcd1.setCursor(0,0);
  lcd1.print(mySubject[value]);
  if(noPeriod==2 && breakR==0){
  brk1=EEPROM.read(2);
    lcd.setCursor(0,0);
    lcd.print("***BREAK TIME***");
    lcd1.setCursor(0,0);
    lcd1.print("***BREAK TIME***");
 ...
 
{
 ...
 
  {
    ...
    case 0:
          ...
          lcd1.createChar(1,Malpha);
          lcd1.createChar(2,Aalpha);
          lcd1.createChar(3,Talpha);
          lcd1.createChar(4,Halpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
    ...
    case 1: 
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Ealpha);
          lcd1.createChar(2,Nalpha);
          lcd1.createChar(3,Galpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
 ...
 //char* mySubject[]={"MATHS", "ENG","BIO","PHY","CHEM","IT LAB","HIST","GEO"};         
    ...
    case 2: 
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Balpha);
          lcd1.createChar(2,Ialpha);
          lcd1.createChar(3,Oalpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
    ...
    case 3:
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Palpha);
          lcd1.createChar(2,Halpha);
          lcd1.createChar(3,Yalpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
 ...
 //char* mySubject[]={"MATHS", "ENG","BIO","PHY","CHEM","IT LAB","HIST","GEO"};
    ...
    case 4: 
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Calpha);
          lcd1.createChar(2,Halpha);
          lcd1.createChar(3,Ealpha);
          lcd1.createChar(4,Malpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
    ...
    case 5: 
          ...
          lcd1.createChar(1,Ialpha);
          lcd1.createChar(2,Talpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
    ...
    case 6: 
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Halpha);
          lcd1.createChar(2,Ialpha);
          lcd1.createChar(3,Salpha);
          lcd1.createChar(4,Talpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
          lcd1.write(2);
 ...
 //char* mySubject[]={"MATHS", "ENG","BIO","PHY","CHEM","IT LAB","HIST","GEO"};
    ...
    case 7: 
          ...
          lcd1.write("     ");
          delay(50);
          lcd1.createChar(1,Galpha);
          lcd1.createChar(2,Ealpha);
          lcd1.createChar(3,Oalpha);
          lcd1.setCursor(0,1);
          lcd1.write(1);
          lcd1.setCursor(1,1);
 ...
 
{
 ...
 
  {
    ...
    case 0://sun
          ...
          lcd1.createChar(5,Salpha);
          lcd1.createChar(6,Ualpha);
          lcd1.createChar(7,Nalpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd1.setCursor(8,0);
          lcd1.write(6);
          lcd1.setCursor(9,0);
          lcd1.write(7);var=1;break;
       ...
       case 1://mon
          ...
          lcd1.createChar(5,Malpha);
          lcd1.createChar(6,Oalpha);
          lcd1.createChar(7,Nalpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd1.setCursor(8,0);
      ...
      case 2://tue
          ...
          lcd1.createChar(5,Talpha);
          lcd1.createChar(6,Ualpha);
          lcd1.createChar(7,Ealpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd.setCursor(8,0);
          lcd1.write(6);
    ...
    case 4://thu
          ...
          lcd1.createChar(5,Talpha);
          lcd1.createChar(6,Halpha);
          lcd1.createChar(7,Ualpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd1.setCursor(8,0);
          lcd1.write(6);
     ...
     case 5://fri
          ...
          lcd1.createChar(5,Falpha);
          lcd1.createChar(6,Ralpha);
          lcd1.createChar(7,Ialpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd1.setCursor(8,0);
          lcd1.write(6);
      ...
      case 6://sat
          ...
          lcd1.createChar(5,Salpha);
          lcd1.createChar(6,Aalpha);
          lcd1.createChar(7,Talpha);
          lcd1.setCursor(7,0);
          lcd1.write(5);
          lcd1.setCursor(8,0);
          lcd1.write(6);
...
void endsession(){
   ...
   lcd1.setCursor(0,0);
   lcd1.print("   Session End  ");
   lcd1.setCursor(0,1);
   lcd1.print("   Good Luck :) ");
